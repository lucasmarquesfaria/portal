...
<body> 
  ...
  <div class="sm:hidden" id="mobile-menu">
    ...
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Fruto do esforço conjunto e dedicação de todos os colaboradores.</h1>

        <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">Este projeto foi realizado graças ao talento e dedicação de nossa equipe. Juntos, superamos desafios e transformamos ideias em realidade, demonstrando nosso compromisso conjunto com o sucesso deste projeto.</p>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" src="https://media.licdn.com/dms/image/D4D03AQHpwzksXHBG4Q/profile-displayphoto-shrink_800_800/0/1719034760082?e=1725494400&v=beta&t=-BQf0frCMSR8G2S8cFbWHiMuLpj8RmJ4wM34OSOFoKA" alt="">

                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">Lucas Marques</h1>

                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Full stack developer</p>
                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300"></p>
